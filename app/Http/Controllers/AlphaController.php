    ...
    public function index(Request $request)
{
    ...
    if ($produk) {
        ...
        return view('Peramalan.alpha', compact('items', 'alphaValues', 'bestValues', 'bestAlpha', 'mae'));
    }
    ...
    public function calculate(int $item, float $alpha, int $bulanRamalan)
{
    ...
    // Inisialisasi at dan bt untuk iterasi pertama
    $at = 0;
    $bt = 0;
    ...
    foreach ($data as $key => $transaksi) {
        ...
        // Menghitung at dan bt untuk iterasi saat ini (naik 1 kolom)
        $at = (2 * $st) - $sst;
        ...
        // Simpan nilai at dan bt untuk iterasi berikutnya
        $prevAt = $at;
        $prevBt = $bt;
