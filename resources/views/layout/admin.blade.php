...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="https://www.emc-indonesia.biz/" class="brand-link">
        <img
          src="{{ asset('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTapnB_jpFYvtX_fWcn8Si9PDWqH_DzYavYzA&s') }}"
          alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light"> EMC Music Centre </span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Selamat Datang kembali</a>
            <h1 style="color:aliceblue">{{Auth::user()->name }}</h1>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            {{-- <li class="nav-item">
              <a href="/peramalanku" class="nav-link">
                <i class="nav-icon fa fa-chart-bar"></i>
                <p>
                  Peramalanku
                  <span class="right badge badge-danger">New</span>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2014-2021 <a href="https://www.emc-indonesia.biz/">EMC Music Centre</a>.</strong>
      All rights reserved.
